...
function Todos() {
   ...
   // #region agent log
   fetch('http://127.0.0.1:7291/ingest/123dea7d-2d38-4d75-95a2-204a53a40061',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'00990d'},body:JSON.stringify({sessionId:'00990d',location:'Todos.jsx:render',message:'Todos selector result',data:{todosIsArray:Array.isArray(todos),todoCount:todos?.length,todoTexts:todos?.map?.(t=>t.text)},timestamp:Date.now(),hypothesisId:'C'})}).catch(()=>{});
   // #endregion
  return (
    <>
    <div>Todos</div>
